## Data Dictionary: Application.PaymentMethods 
 <br /> 
 <br /> 
...
<br /> 
 | Column | Remarks | 
 |------|------|  
|**PaymentMethodID**| Numeric ID used for reference to a payment type within the database | 
|**PaymentMethodName**| Full name of ways that customers can make payments or that suppliers can be paid | 
|**LastEditedBy**| Null | 
|**ValidFrom**| Null | 
|**ValidTo**| Null | 
...
<br /> 
 ...
 |------|------|------|------|------|------|------|------|------|------|------|
 |**PaymentMethodID**| (NEXT VALUE FOR [Sequences].[PaymentMethodID]) | NO | int | Null | Null | 10 | 0 | Null | Null | Null | 
